...
double calculatePostfixExpression(string prefixExpression);
...
double calculatePostfixExpression(string prefixExpression){
    return calculatePostfixExpression(convertPrefixExpressionToPostfixExpression(splitPrefixExpression(prefixExpression)));
}

int main() {
    string expression = "9 + 6*(3 - (3 + 9) *1) * 3 + 10 / 2";
    cout << calculatePostfixExpression(expression) << endl;
    return 0;
}
